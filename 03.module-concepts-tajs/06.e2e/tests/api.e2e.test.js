...
describe('E2E Test Suite', () => {
  ...
  describe('E2E Tests for server', () => {
    ...
    it('should return 400 and missing file message when body is invalid', async () => {
      const invalidPerson = { name: 'Thalles Ian' }
    ...
    it('should return 400 and missing file message when body is invalid', async () => {
      const invalidPerson = { cpf: '489.502.368-00' }
      const response = await fetch(`${_testServerAddress}/persons`, {
        method: 'POST',
        body: JSON.stringify(invalidPerson)
      })
    ...
    it('should return 200 and save person', async () => {
      const validPerson = { name: 'Thalles Ian', cpf: '489.502.368-00' }
      const response = await fetch(`${_testServerAddress}/persons`, {
        method: 'POST',
